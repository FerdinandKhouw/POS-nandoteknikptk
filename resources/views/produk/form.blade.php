        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">{{-- nama_produk --}}
                    ...
                    <div class="form-group row">{{-- id_kategori --}}
                        <label for="id_kategori" class="col-lg-2 col-lg-offset-1 control-label">Merk</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">{{-- merk --}}
                        <label for="merk" class="col-lg-2 col-lg-offset-1 control-label">Nama Item</label>
                        <div class="col-lg-6">
