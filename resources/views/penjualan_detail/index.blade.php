                ...
                <div class="box-body">
                    ...
                    <form class="form-produk">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-5">
                                <div onclick="tampilProduk()" class="input-group">
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <div onclick="tampilMember()" class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button onclick="tampilMember()" class="btn btn-info btn-flat"
                                                    type="button"><i class="fa fa-arrow-right" required></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="diterima" class="col-lg-2 control-label">Uang Diterima</label>
                                    <div class="col-lg-8">
